...
const SIZE = {
  xs:  { box: 'w-[70px]',  num: 'text-lg',   name: 'text-[9px]',  h: 'h-[100px]', showBody: false },
  sm:  { box: 'w-[86px]',  num: 'text-xl',   name: 'text-[10px]', h: 'h-[124px]', showBody: false },
  md:  { box: 'w-[110px]', num: 'text-3xl',  name: 'text-[11px]', h: 'h-[160px]', showBody: true  },
  lg:  { box: 'w-[160px]', num: 'text-5xl',  name: 'text-[14px]', h: 'h-[230px]', showBody: true  },
} as const
